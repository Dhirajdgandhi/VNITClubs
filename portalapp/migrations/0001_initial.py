    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recentdate', models.DateField(default=datetime.date(2017, 10, 27))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(default=datetime.datetime(2017, 10, 27, 17, 5, 4, 644000))),
                ('valid', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_of_rounds', models.IntegerField(default=0)),
                ('other_comments', models.TextField(default=b'')),
                ('timestamp', models.DateTimeField(default=datetime.datetime(2017, 10, 27, 17, 5, 4, 636000))),
                ('valid', models.IntegerField(default=0)),
                ('selected', models.IntegerField(default=1)),
                ('cdr_id', models.ForeignKey(to='portalapp.Company_Department_Relation', null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(default=datetime.datetime(2017, 10, 27, 17, 5, 4, 653000))),
            ],
        ),
        migrations.CreateModel(
            name='ForLogin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdondate', models.DateField(default=datetime.date(2017, 10, 27))),
